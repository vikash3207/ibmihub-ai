...
export const DEEP_DIVES: DeepDive[] = [
  ...
  },
  {
    ...
    relatedPracticeTopics: ['sqlrpgle-basics', 'advanced-sql'],
    relatedDeepDiveSlugs: ['embedded-sql-in-rpgle', 'stored-procedures-on-ibm-i', 'sql-error-handling-with-sqlcode-and-sqlstate'],
  ...
  },
  {
    ...
    relatedPracticeTopics: ['advanced-sql', 'sqlrpgle-basics'],
    relatedDeepDiveSlugs: ['sql-on-ibm-i', 'embedded-sql-in-rpgle', 'sql-cursors-on-ibm-i', 'stored-procedures-on-ibm-i'],
    lastUpdated: '2026-07-21',
  },
  {
