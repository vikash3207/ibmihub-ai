...
export const DEEP_DIVES: DeepDive[] = [
  ...
  },
  {
    ...
    relatedPracticeTopics: ['sqlrpgle-basics', 'advanced-sql'],
    relatedDeepDiveSlugs: ['embedded-sql-in-rpgle', 'stored-procedures-on-ibm-i', 'sql-error-handling-on-ibm-i'],
  ...
  },
  {
    ...
    status: 'published',
    estimatedReadTime: 22,
    tags: ['sql', 'stored-procedures', 'db2-for-i', 'sql-pl', 'rpgle'],
    relatedLessonSlugs: ['sql-stored-procedures-on-ibm-i', 'external-stored-procedures-with-rpgle'],
    relatedPracticeTopics: ['advanced-sql', 'sqlrpgle-basics'],
    relatedDeepDiveSlugs: ['sql-on-ibm-i', 'embedded-sql-in-rpgle', 'sql-cursors-on-ibm-i', 'database-triggers-on-ibm-i'],
  ...
  },
  {
    ...
    tags: ['sql', 'triggers', 'db2-for-i', 'sql-pl', 'rpgle'],
    relatedLessonSlugs: ['sql-triggers-on-ibm-i'],
    relatedPracticeTopics: ['advanced-sql', 'sqlrpgle-basics'],
    relatedDeepDiveSlugs: ['sql-on-ibm-i', 'embedded-sql-in-rpgle', 'sql-cursors-on-ibm-i', 'stored-procedures-on-ibm-i', 'sql-error-handling-on-ibm-i'],
    lastUpdated: '2026-07-21',
  },
  {
    ...
    tags: ['sql', 'sqlcode', 'sqlstate', 'error-handling', 'sql-pl', 'rpgle'],
    relatedLessonSlugs: ['sqlcode-and-sqlstate-basics-in-sqlrpgle', 'sqlca-sqlcode-and-sqlstate-in-depth'],
    relatedPracticeTopics: ['advanced-sql', 'sqlrpgle-basics'],
    relatedDeepDiveSlugs: ['sql-on-ibm-i', 'embedded-sql-in-rpgle', 'sql-cursors-on-ibm-i', 'stored-procedures-on-ibm-i', 'database-triggers-on-ibm-i'],
    lastUpdated: '2026-07-21',
  },
  {
