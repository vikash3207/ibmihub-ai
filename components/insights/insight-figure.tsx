...
const ACCENT_CLASSES: Record<InsightFigureAccent, { border: string; wash: string; badgeBg: string; badgeText: string }> = {
  cyan: { border: 'border-t-cyan-500', wash: 'from-cyan-50 via-white to-white', badgeBg: 'bg-cyan-100', badgeText: 'text-cyan-800' },
  indigo: { border: 'border-t-indigo-500', wash: 'from-indigo-50 via-white to-white', badgeBg: 'bg-indigo-100', badgeText: 'text-indigo-800' },
  violet: { border: 'border-t-violet-500', wash: 'from-violet-50 via-white to-white', badgeBg: 'bg-violet-100', badgeText: 'text-violet-800' },
  blue: { border: 'border-t-blue-500', wash: 'from-blue-50 via-white to-white', badgeBg: 'bg-blue-100', badgeText: 'text-blue-800' },
  emerald: { border: 'border-t-emerald-500', wash: 'from-emerald-50 via-white to-white', badgeBg: 'bg-emerald-100', badgeText: 'text-emerald-800' },
  amber: { border: 'border-t-amber-500', wash: 'from-amber-50 via-white to-white', badgeBg: 'bg-amber-100', badgeText: 'text-amber-800' },
}
...
export function InsightFigure({ number, title, caption, accent, scrollable = false, children }: InsightFigureProps) {
  ...
  return (
    ...
    >
      ...
      <figcaption className="border-t border-slate-100 bg-white/60 px-5 py-4 text-sm leading-relaxed text-slate-600 sm:px-6">
        {caption}
      </figcaption>
    </figure>
  )
