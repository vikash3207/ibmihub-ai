 ...
 * figures.tsx, and any future article's own figure file) into one map keyed
 * by Insight slug. Each per-article file stays scoped to its own article and
 * never has to import or know about another article's figures -- adding a
 * third Insight with diagrams means adding one more spread here, not editing
 * an existing article's figure file.
 */
