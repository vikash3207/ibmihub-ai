          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <Card className="flex flex-col p-6">
              ...
              <p className="text-sm text-slate-600 leading-relaxed mb-4 flex-1">
                Reinforce concepts with guided practice, test yourself with quick quizzes, prepare with real
                interview questions, and get hands-on in a simulated 5250-style command environment and an
                ACS-style SQL console --{' '}
